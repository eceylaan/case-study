...
export default function Home() {
  return (
    <div className="text-white relative overflow-x-hidden bg-white">
      <header
        className="min-h-[100vh] flex flex-col justify-center items-center p-6 
      ...
      >
        <main className="text-center max-w-5xl">
          ...
          <h2 className="text-5xl sm:text-7xl md:text-8xl font-extrabold mb-6 leading-tight sm:leading-snug">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-white">Etkiyi Yönetin.</span>
            <br />
            Veriyle Büyüyün.
          </h2>

          <p className="text-xl md:text-2xl text-gray-400 mb-10 max-w-4xl mx-auto">
            Dünyanın en sofistike influencer pazarlama analitik platformu ile markanızın potansiyelini zirveye taşıyın, her kararı
            veriye dayandırın.
          </p>
      ...
      <section className="py-32 px-6 bg-white text-gray-900 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600">
            Infofluencer, sıradan ölçüm araçlarının ötesine geçer. Size özel premium portföyler oluşturur, ROI'nizi maksimize eder
            ve marka hikayenizi doğru kitleye ulaştırmanızı garanti eder.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50 overflow-hidden relative">
        <div className="max-w-7xl mx-auto text-center mb-8">
          <h4 className="text-xl font-semibold text-gray-600">Infofluencer'a Güvenen Büyük Markalar</h4>
        </div>
        ...
        <div className="flex w-full whitespace-nowrap animate-infinite-scroll">
          {clientLogos.map((logo, index) => (
            ...
            >
              <span className="text-3xl font-extrabold text-gray-400">{logo.name}</span>
            </div>
          ))}
        </div>
      ...
      <section className="py-28 px-6 flex flex-col items-center bg-purple-900 text-white">
        <div className="max-w-5xl w-full text-center mb-16">
          <h4 className="text-sm font-semibold tracking-widest mb-3 text-purple-400 uppercase">REKABET AVANTAJINIZ</h4>
      ...
      <footer className="py-8 text-sm text-gray-500 text-center bg-black">
